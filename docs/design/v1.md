...
| **Bridge key** | A secret, versioned bearer value containing a transport kind, opaque locator, and random capability. |
...
4. prints a redacted summary plus a `DUMBRIDGE_KEY` value;
